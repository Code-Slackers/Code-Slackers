      ...
      <div className="flex justify-between w-full lg:flex-col lg:justify-center lg:items-center">
        <div className="z-10 flex flex-col lg:justify-center lg:items-center">
          <Link className="text-dark" to="/">
            <h1 className="pb-2 text-2xl font-bold text-secondary md:text-4xl lg:text-5xl">tripr</h1>
          </Link>
          <p className="mb-2 font-bold text-gray-300 md:text-lg lg:text-xl">Find Your Next Adventure</p>
        </div>
