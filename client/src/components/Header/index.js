  ...
  return (
    <header className="relative px-2 py-2 mb-4 bg-primary text-dark lg:px-3 lg:py-5">
      <div className="flex justify-between w-full lg:flex-col lg:justify-center lg:items-center">
        ...
        <div
          className={`bg-primary pb-2 lg:pb-0 lg:static absolute left-0 w-full duration-200 lg:z-10 ${
            open ? "z-0 top-[100%]" : "z-[-10] top-[-100%]"
          }`}
        >
          {Auth.loggedIn() ? (
            <div className="flex items-center justify-center gap-3 mt-3">
              ...
              <button
                className="h-10 gap-1 btn btn-secondary btn-sm"
                onClick={logout}
              >
              ...
              <Link
                to={"/"}
                className="flex items-center justify-center w-10 h-10 bg-white rounded-md hover:bg-slate-200"
              >
                <svg
