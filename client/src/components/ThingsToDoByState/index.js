      ...
      {thingsToDo &&
        thingsToDo.map((thingToDo) => (
          <div
            key={thingToDo._id}
            id={thingToDo._id}
            className="p-4 space-y-4 border border-gray-200 rounded-md shadow-md sm:p-6 card-header text-light"
          >
            ...
            <button
              className="px-4 py-2 text-white bg-black rounded-lg shadow-md hover:bg-primary focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50"
              onClick={() => {
